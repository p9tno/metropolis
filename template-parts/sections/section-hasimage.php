      ...
      <div class="container_center">
          <div class="hasimage__content">
            <?php if (SCF::get( 'hasimage__title' )) { ?>
              <h2 class="section__title animate_fade delay_0 fade_scroll_js"><?php echo SCF::get( 'hasimage__title' ); ?></h2>
            <?php } ?>
            ...
            <?php if (SCF::get( 'hasimage__text' )) { ?>
              <div class="hasimage__text animate_fade delay_0 fade_scroll_js"><?php echo SCF::get( 'hasimage__text' ); ?></div>
            <?php } ?>
          </div>
      </div>
  </section>
